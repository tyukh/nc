...
let PreferencesInterface: any;

export default function prefsInterface(
  window: Adw.PreferencesWindow,
  prefs: ExtensionPreferences
): Adw.PreferencesPage {
  if (PreferencesInterface === undefined) {
    PreferencesInterface = GObject.registerClass(
      {
        GTypeName: 'PreferencesInterface',
        Template: prefs.dir.get_child('ui').get_child('prefs.ui').get_uri()!,
  ...
  return new PreferencesInterface(window, prefs);
}
